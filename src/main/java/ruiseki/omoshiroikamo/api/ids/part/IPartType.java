...
public interface IPartType<P extends IPartType<P, S>, S extends IPartState<P>>
     ...
     */
    // public IBlockState getBlockState(IPartContainer partContainer, ForgeDirection side);
     ...
     * @param state   The state
     * @param target  The target block.
     * @param updated If the {@link INetworkElement#update(ruiseki.omoshiroikamo.api.ids.network.INetwork)} was called.
     */
