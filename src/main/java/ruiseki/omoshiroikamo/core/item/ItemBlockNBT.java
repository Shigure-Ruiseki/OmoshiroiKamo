...
/**
 * An extended {@link ItemBlockOK} that will add the NBT data that is stored inside
 * the item to the placed {@link TileEntity} for the blockState.
 * Subinstances of {@link ConfigurableBlockContainer} will perform the
 * inverse operation, being
 * that broken blocks will save the NBT data inside the dropped {@link ItemBlock}.
 *
 * @author rubensworks
 *
 */
public class ItemBlockNBT extends ItemBlockOK {
