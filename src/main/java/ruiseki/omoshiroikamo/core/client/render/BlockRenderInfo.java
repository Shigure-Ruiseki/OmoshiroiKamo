...
import ruiseki.omoshiroikamo.core.client.texture.TmpFlippableIcon;
import ruiseki.omoshiroikamo.core.tileentity.TileEntityOK;

public class BlockRenderInfo {

    private final BaseBlockRender<? extends BlockOK, ? extends TileEntityOK> rendererInstance;
    ...
    public BlockRenderInfo(final BaseBlockRender<? extends BlockOK, ? extends TileEntityOK> inst) {
