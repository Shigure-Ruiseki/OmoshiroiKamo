...
import ruiseki.omoshiroikamo.core.energy.capability.WrappedEnergyIO;
import ruiseki.omoshiroikamo.core.energy.capability.cofh.CoFHEnergyHandler;
import ruiseki.omoshiroikamo.core.energy.capability.cofh.CoFHEnergyProvider;
import ruiseki.omoshiroikamo.core.energy.capability.cofh.CoFHEnergyReceiver;
import ruiseki.omoshiroikamo.core.energy.capability.ic2.IC2EnergySink;
import ruiseki.omoshiroikamo.core.energy.capability.ic2.IC2EnergySource;
import ruiseki.omoshiroikamo.core.energy.capability.ok.OKEnergyIO;
import ruiseki.omoshiroikamo.core.energy.capability.ok.OKEnergySink;
import ruiseki.omoshiroikamo.core.energy.capability.ok.OKEnergySource;
    ...
    public static EnergyIO wrapIC2Energy(Object obj, ForgeDirection side) {
        ...
        try {
            ...
            if (sinkClass.isInstance(obj)) {
                return new IC2EnergySink((TileEntity) obj, side);
            }
        } catch (ClassNotFoundException ignored) {}
        ...
        try {
            ...
            if (sourceClass.isInstance(obj)) {
                return new IC2EnergySource((TileEntity) obj, side);
            }
        } catch (ClassNotFoundException ignored) {}
