 ...
 */
public class BlockEssentiaOutputPort extends AbstractTieredBlock<TEEssentiaOutputPort> implements IModularBlock {
    ...
    public static class ItemBlockEssentiaOutputPort extends ItemBlockOK {
