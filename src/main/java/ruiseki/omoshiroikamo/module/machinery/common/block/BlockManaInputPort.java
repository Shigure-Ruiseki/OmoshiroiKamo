...
/**
 * Mana Input Port block with unified 16-tier system.
 * Uses a single TE class (TEManaInputPort) with tier field instead of per-tier TE classes.
 *
 * Legacy TE classes (TEManaInputPortT1) are automatically remapped to TEManaInputPort.
 */
public class BlockManaInputPort extends AbstractPortBlock<TEManaInputPort> implements IWandHUD {
    ...
    protected BlockManaInputPort() {
        ...
        super(ModObject.blockModularManaInput.unlocalisedName, TEManaInputPort.class);
        setHardness(5.0F);
        setResistance(10.0F);
