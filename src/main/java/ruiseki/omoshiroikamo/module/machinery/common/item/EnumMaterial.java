...
public enum EnumMaterial {
    ...
    // Alloy
    // STONE(120, "stone", "Stone"),
    // ANDESITE(121, "andesite", "Andesite"),
    // DIORITE(122, "diorite", "Diorite"),
    // GRANITE(123, "granite", "Granite"),
    // DEEPSLATE(124, "deepslate", "Deepslate"),
    // ALABASTER(125, "alabaster", "Alabaster"),
    // BASALT(126, "basalt", "Basalt"),
    // HARDENEDSTONE(127, "hardenedstone", "HardenedStone"),
    // CALCITE(128, "calcite", "Calcite"),
    // TUFF(129, "tuff", "Tuff"),
    // MICA(130, "mica", "Mica"),
    // PRISMARINE(131, "prismarine", "Prismarine"),
