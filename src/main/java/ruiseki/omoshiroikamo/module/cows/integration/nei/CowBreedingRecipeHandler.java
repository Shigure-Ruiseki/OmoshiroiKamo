...
public class CowBreedingRecipeHandler extends RecipeHandlerBase {
    ...
    public void loadCraftingRecipes(ItemStack result) {
        ...
        for (CowsRegistryItem cow : CowsRegistry.INSTANCE.getItems()) {
            ItemStack egg = CowsItems.COW_SPAWN_EGG.newItemStack(1, cow.getId());
    ...
    public void loadUsageRecipes(ItemStack ingredient) {
        ...
        for (CowsRegistryItem cow : CowsRegistry.INSTANCE.getItems()) {
            ...
            ItemStack egg1 = CowsItems.COW_SPAWN_EGG.newItemStack(1, p1.getId());
            ItemStack egg2 = CowsItems.COW_SPAWN_EGG.newItemStack(1, p2.getId());
    ...
    public class CachedCowsRecipe extends CachedBaseRecipe {
        ...
        public List<PositionedStack> getIngredients() {
            ...
            if (cow.getParent1() != null && cow.getParent2() != null) {
                ...
                ItemStack egg1 = CowsItems.COW_SPAWN_EGG.newItemStack(1, parent1.getId());
                PositionedStack parent1Egg = new PositionedStack(egg1, 50, 26);
                stacks.add(parent1Egg);

                CowsRegistryItem parent2 = cow.getParent2();
                ItemStack egg2 = CowsItems.COW_SPAWN_EGG.newItemStack(1, parent2.getId());
        ...
        public PositionedStack getResult() {
            return new PositionedStack(CowsItems.COW_SPAWN_EGG.newItemStack(1, cow.getId()), 74, 40);
        }
