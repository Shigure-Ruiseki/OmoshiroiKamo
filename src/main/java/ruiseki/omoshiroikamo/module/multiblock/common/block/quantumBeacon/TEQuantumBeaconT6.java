...
import static ruiseki.omoshiroikamo.module.multiblock.common.block.quantumBeacon.QuantumBeaconShapes.STRUCTURE_TIER_6;
import static ruiseki.omoshiroikamo.module.multiblock.common.block.quantumBeacon.QuantumBeaconShapes.TIER_OFFSET;
import static ruiseki.omoshiroikamo.module.multiblock.common.block.quantumBeacon.QuantumBeaconStructure.STRUCTURE_DEFINITION_TIER_6;
...
public class TEQuantumBeaconT6 extends TEQuantumBeacon {

    public TEQuantumBeaconT6() {
        super(400000);
    }

    @Override
    protected int maxPotionLevel(String attribute) {
        QuantumBeaconConfig.BeaconTierConfig config = QuantumBeaconConfig.tier6;
    ...
    @Override
    protected IStructureDefinition<TEQuantumBeaconT6> getStructureDefinition() {
