...
import static ruiseki.omoshiroikamo.module.multiblock.common.block.quantumExtractor.ore.QuantumOreExtractorShapes.STRUCTURE_TIER_3;
...
import static ruiseki.omoshiroikamo.module.multiblock.common.block.quantumExtractor.ore.QuantumOreExtractorStructure.STRUCTURE_DEFINITION_TIER_3;
...
public class TEQuantumOreExtractorT3 extends TEQuantumExtractor {
    ...
    public int getMinDuration() {
        return QuantumExtractorConfig.oreMiner.getMinTick(3);
    }

    @Override
    public int getMaxDuration() {
        return QuantumExtractorConfig.oreMiner.getMaxTick(3);
    }
}
