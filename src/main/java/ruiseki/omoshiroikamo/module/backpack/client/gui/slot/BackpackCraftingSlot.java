...
public class BackpackCraftingSlot extends ModularCraftingMatrixSlot {
    ...
    public BackpackCraftingSlot(IItemHandler itemHandler, int index, BackpackHandler handler, int slotIndex) {
