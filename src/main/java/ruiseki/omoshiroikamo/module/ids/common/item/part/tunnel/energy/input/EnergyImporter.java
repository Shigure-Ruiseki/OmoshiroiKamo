...
public class EnergyImporter extends AbstractWriterPart implements IEnergyPart {
    ...
    public @NotNull ModularPanel partPanel(SidedPosGuiData data, PanelSyncManager syncManager, UISettings settings) {
        ...
        addSearchableRow(
            list,
            LangHelpers.localize("gui.ids.energyImporter.boolean"),
            writerSlotRow(0, LangHelpers.localize("gui.ids.energyImporter.boolean"), allSetting),
            searchValue);

        addSearchableRow(
            list,
            LangHelpers.localize("gui.ids.energyImporter.amount"),
            writerSlotRow(1, LangHelpers.localize("gui.ids.energyImporter.amount"), allSetting),
            searchValue);
