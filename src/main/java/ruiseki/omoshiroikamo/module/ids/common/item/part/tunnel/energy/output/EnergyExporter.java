...
public class EnergyExporter extends AbstractWriterPart implements IEnergyPart {
    ...
    public void registerModel() {
        ...
        active = new ResourceLocation(Reference.PREFIX_ITEM + "ids/part/energy_exporter_active.png");
        inactive = new ResourceLocation(Reference.PREFIX_ITEM + "ids/part/energy_exporter_inactive.png");
    ...
    private void executeExport(ILogicValue value, Mode mode) {
        ...
        for (IEnergyNet iFace : network.interfaces) {
            ...
            transfer.sink(EnergyHelpers.getEnergySink(getTargetTE(), side.getOpposite()));
