...
public class ItemExporter extends AbstractWriterPart implements IItemPart {
    ...
    public void registerModel() {
        ...
        active = new ResourceLocation(Reference.PREFIX_ITEM + "ids/part/item_exporter_active.png");
        inactive = new ResourceLocation(Reference.PREFIX_ITEM + "ids/part/item_exporter_inactive.png");
    }
    ...
    private void executeExport(ILogicValue value, Mode mode) {
        ...
        if (roundRobin) {
            ...
            transfer.sink(ItemStackHelpers.getItemSink(getTargetTE(), side.getOpposite()));
