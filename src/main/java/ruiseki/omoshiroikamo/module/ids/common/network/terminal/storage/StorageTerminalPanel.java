...
import ruiseki.omoshiroikamo.module.ids.client.gui.syncHandler.ItemIndexSH;
import ruiseki.omoshiroikamo.module.ids.client.gui.widget.CraftingFilterButton;
import ruiseki.omoshiroikamo.module.ids.client.gui.widget.IDsCraftingSlot;
import ruiseki.omoshiroikamo.module.ids.client.gui.widget.IDsItemSlot;
import ruiseki.omoshiroikamo.module.ids.client.gui.widget.IDsScrollBar;
import ruiseki.omoshiroikamo.module.ids.client.gui.widget.SortOrderButton;
import ruiseki.omoshiroikamo.module.ids.client.gui.widget.SortTypeButton;
import ruiseki.omoshiroikamo.module.ids.common.network.tunnel.item.ItemIndexClient;
...
public class StorageTerminalPanel extends ModularPanel {
    ...
    public IDsScrollBar scrollBar;
    public SearchBarWidget searchBar;
    public StringSyncValue searchSyncer;
    public IDsItemSlot[] slots = new IDsItemSlot[SLOT_COUNT];
    ...
    public StorageTerminalPanel(GuiData data, PanelSyncManager syncManager, UISettings settings,
        ...
        syncManager.syncValue("storage_terminal_sh", syncHandler);
        ...
        scrollBar = new IDsScrollBar().top(18)
            .size(14, ROWS * 18)
    ...
    private void buildItemGrid() {
        for (int i = 0; i < SLOT_COUNT; i++) {
            IDsItemSlotSH slotSH = new IDsItemSlotSH(terminal);
        ...
        for (int i = 0; i < SLOT_COUNT; i++) {
            ...
            IDsItemSlot slot = new IDsItemSlot() {
    ...
    private void buildCraftingGrid() {
        IDsCraftingSlot craftingResultSlot = new IDsCraftingSlot(terminal.craftingStackHandler, 9, terminal);
