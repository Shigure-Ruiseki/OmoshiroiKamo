...
import ruiseki.omoshiroikamo.api.ids.block.cable.ICableNetwork;
...
import ruiseki.omoshiroikamo.api.ids.tileentity.ITileCable;
...
import ruiseki.omoshiroikamo.module.ids.common.network.PartNetwork;
import ruiseki.omoshiroikamo.module.ids.common.path.CablePathElement;
...
public class CableNetworkComponent<C extends ICableNetwork<IPartNetwork, ICablePathElement>>
    ...
    public CablePathElement createPathElement(World world, BlockPos blockPos) {
        return new CablePathElement(cable, DimPos.of(world.provider.dimensionId, blockPos));
    }
    ...
    public void setNetwork(IPartNetwork network, World world, BlockPos pos) {
        ...
        if (tile != null) {
            if (network != null && tile.getNetwork() != null) {
                Logger.warn("Tried to set a new network for a tile without the previous one being removed.");
            }
