    ...
    public @NotNull ModularPanel partPanel(SidedPosGuiData data, PanelSyncManager syncManager, UISettings settings) {
        ...
        addSearchableRow(
            ...
            IKey.lang("gui.ids.fluidReader.tankNotEmpty")
                .get(),
            infoRow(
                "gui.ids.fluidReader.tankNotEmpty",
        ...
        addSearchableRow(
            ...
            IKey.lang("gui.ids.fluidReader.fluidAmount")
                .get(),
            infoRow("gui.ids.fluidReader.fluidAmount", IKey.dynamic(() -> {
        ...
        addSearchableRow(
            ...
            IKey.lang("gui.ids.fluidReader.totalAmount")
                .get(),
            infoRow(
                "gui.ids.fluidReader.totalAmount",
        ...
        addSearchableRow(
            ...
            IKey.lang("gui.ids.fluidReader.fluidCapacity")
                .get(),
            infoRow("gui.ids.fluidReader.fluidCapacity", IKey.dynamic(() -> {
        ...
        addSearchableRow(
            ...
            IKey.lang("gui.ids.fluidReader.totalCapacity")
                .get(),
            infoRow(
                "gui.ids.fluidReader.totalCapacity",
        ...
        addSearchableRow(
            ...
            IKey.lang("gui.ids.fluidReader.fillRatio")
                .get(),
            infoRow("gui.ids.fluidReader.fillRatio", IKey.dynamic(() -> {
        ...
        addSearchableRow(
            ...
            IKey.lang("gui.ids.fluidReader.tankFluids")
                .get(),
            infoRow(
                "gui.ids.fluidReader.tankFluids",
        ...
        addSearchableRow(
            ...
            IKey.lang("gui.ids.fluidReader.tankCapacities")
                .get(),
            infoRow(
                "gui.ids.fluidReader.tankCapacities",
        ...
        addSearchableRow(
            ...
            IKey.lang("gui.ids.fluidReader.tankFluid")
                .get(),
            infoRow("gui.ids.fluidReader.tankFluid", IKey.dynamic(() -> {
