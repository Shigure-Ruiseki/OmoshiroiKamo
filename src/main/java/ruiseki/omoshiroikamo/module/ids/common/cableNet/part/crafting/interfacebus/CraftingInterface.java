package ruiseki.omoshiroikamo.module.ids.common.cableNet.part.crafting.interfacebus;
...
import ruiseki.omoshiroikamo.module.ids.common.cableNet.part.crafting.ICraftingPart;
import ruiseki.omoshiroikamo.module.ids.common.cableNet.part.crafting.ICraftingPattern;
...
public class CraftingInterface extends AbstractPart implements ICraftingPart {
    ...
    public void registerModel() {
        ...
        texture = new ResourceLocation(LibResources.PREFIX_ITEM + "ids/part/crafting_interface_bus.png");
    }
    ...
    public boolean execute(ICraftingPattern pattern, long times) {

        // 1. check storage đủ input
        // 2. extract input
        // 3. insert output
