package ruiseki.omoshiroikamo.module.ids.common.network.logic.reader.block;
...
public class BlockReader extends AbstractReaderPart implements IBlockPart {
    ...
    public @NotNull ModularPanel partPanel(SidedPosGuiData data, PanelSyncManager syncManager, UISettings settings) {
        ...
        addSearchableRow(
            list,
            IKey.lang("gui.ids.blockReader.hasBlock")
                .get(),
            infoRow(
                "gui.ids.blockReader.hasBlock",
        ...
        addSearchableRow(
            list,
            IKey.lang("gui.ids.blockReader.dimension")
                .get(),
            infoRow(
                "gui.ids.blockReader.dimension",
        ...
        addSearchableRow(
            list,
            IKey.lang("gui.ids.blockReader.coord.x")
                .get(),
            infoRow(
                "gui.ids.blockReader.coord.x",
        ...
        addSearchableRow(
            list,
            IKey.lang("gui.ids.blockReader.coord.y")
                .get(),
            infoRow(
                "gui.ids.blockReader.coord.y",
        ...
        addSearchableRow(
            list,
            IKey.lang("gui.ids.blockReader.block")
                .get(),
            infoRow(
                "gui.ids.blockReader.block",
                IKey.dynamic(
                    () -> String.valueOf(
        ...
        addSearchableRow(
            list,
            IKey.lang("gui.ids.blockReader.biome")
                .get(),
            infoRow(
                "gui.ids.blockReader.biome",
        ...
        addSearchableRow(
            list,
            IKey.lang("gui.ids.blockReader.light")
                .get(),
            infoRow(
                "gui.ids.blockReader.light",
