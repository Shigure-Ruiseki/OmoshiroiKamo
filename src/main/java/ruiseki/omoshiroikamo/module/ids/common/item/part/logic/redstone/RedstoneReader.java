...
public class RedstoneReader extends AbstractReaderPart implements ILogicReaderPart, IRedstoneReader {
    ...
    public @NotNull ModularPanel partPanel(SidedPosGuiData data, PanelSyncManager syncManager, UISettings settings) {
        ...
        addSearchableRow(
            list,
            LangHelpers.localize("gui.ids.redstoneReader.redstoneValue"),
            infoRow(
                LangHelpers.localize("gui.ids.redstoneReader.redstoneValue"),
        ...
        addSearchableRow(
            list,
            LangHelpers.localize("gui.ids.redstoneReader.hasRedstone"),
            infoRow(
                LangHelpers.localize("gui.ids.redstoneReader.hasRedstone"),
        ...
        addSearchableRow(
            list,
            LangHelpers.localize("gui.ids.redstoneReader.highRedstone"),
            infoRow(
                LangHelpers.localize("gui.ids.redstoneReader.highRedstone"),
        ...
        addSearchableRow(
            list,
            LangHelpers.localize("gui.ids.redstoneReader.lowRedstone"),
            infoRow(
                LangHelpers.localize("gui.ids.redstoneReader.lowRedstone"),
    ...
    public void registerModel() {
        ...
        texture = new ResourceLocation(Reference.PREFIX_ITEM + "ids/part/redstone_reader_front.png");
