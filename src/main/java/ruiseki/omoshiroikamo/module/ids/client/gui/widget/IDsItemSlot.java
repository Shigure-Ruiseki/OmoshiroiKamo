...
public class IDsItemSlot extends Widget<IDsItemSlot> implements Interactable, RecipeViewerIngredientProvider {
    ...
    private IDsItemSlotSH syncHandler;
    ...
    public IDsItemSlot setEntry(@Nullable ItemStackKey key, int storedCount, boolean craftable) {
        this.key = key;
    ...
    @Override
    public @NotNull IDsItemSlotSH getSyncHandler() {
