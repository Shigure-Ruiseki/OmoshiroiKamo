...
public class StorageSlot extends ItemSlot {
    ...
    public StorageSlot(StoragePanel panel, StorageWrapper wrapper) {
        this.panel = panel;
    ...
    private void drawSettingStack(ModularGuiContext context, WidgetTheme widgetTheme) {
        ...
        ItemStack memoryStack = wrapper.storageItemStackHandler.memorizedSlotStack.get(getSlot().slotNumber);
