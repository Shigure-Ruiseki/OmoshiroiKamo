...
import ruiseki.omoshiroikamo.module.storage.client.gui.handler.InventoryCraftingWrapper;
...
public class IndexedModularCraftingSlot extends ModularCraftingSlot {
    ...
    public IndexedModularCraftingSlot(int upgradeSlotIndex, StorageWrapper wrapper, IItemHandler inv, int invIndex) {
        super(inv, invIndex);
