...
public class ItemMagnetUpgrade extends ItemUpgrade<MagnetUpgradeWrapper> {
    ...
    public ItemMagnetUpgrade() {
        super(ModObject.STORAGE_MAGNET_UPGRADE.name);
        setMaxStackSize(1);
        setTextureName("storage/magnet_upgrade");
    }
    ...
    public void addInformation(ItemStack itemstack, EntityPlayer entityplayer, List<String> list, boolean flag) {
        list.add(LangHelpers.localize(LibResources.TOOLTIP + "storage.magnet_upgrade"));
    }

    @Override
    public MagnetUpgradeWrapper createWrapper(ItemStack stack, IStorageWrapper wrapper) {
        return new MagnetUpgradeWrapper(stack, wrapper);
    }
}
