...
public class CollidableComponent {
    ...
    public CollidableComponent(Class<? extends IConduit> conduitType, BoundingBox bound, ForgeDirection id,
        Object data) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof CollidableComponent other) {
            return conduitType == other.conduitType && bound.equals(other.bound) && dir == other.dir;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((conduitType == null) ? 0
            : conduitType.getName()
                .hashCode());
