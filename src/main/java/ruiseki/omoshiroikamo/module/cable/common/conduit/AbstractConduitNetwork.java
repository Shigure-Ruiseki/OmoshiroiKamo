...
public abstract class AbstractConduitNetwork<T extends IConduit, I extends T> {
    ...
    public void addConduit(I con) {
        if (!conduits.contains(con)) {
            if (conduits.isEmpty()) {
                CableCommon.conduitNetworkTickHandler.registerNetwork(this);
            }
            conduits.add(con);
        }
    }
    ...
    public void destroyNetwork() {
        ...
        conduits.clear();
        CableCommon.conduitNetworkTickHandler.unregisterNetwork(this);
    }
