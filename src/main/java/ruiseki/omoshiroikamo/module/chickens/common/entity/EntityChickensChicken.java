package ruiseki.omoshiroikamo.module.chickens.common.entity;
...
import ruiseki.omoshiroikamo.core.compat.waila.IWailaEntityInfoProvider;
...
public class EntityChickensChicken extends EntityChicken
    ...
    public void getWailaInfo(List<String> tooltip, EntityPlayer player, World world, Entity entity) {
        ...
        tooltip.add(LangHelpers.localize(Reference.TOOLTIP + "mob.tier", chicken.getTier()));

        if (chicken.getStatsAnalyzed() || ChickenConfig.alwaysShowStats) {
            tooltip.add(LangHelpers.localize(Reference.TOOLTIP + "mob.growth", chicken.getGrowth()));
            tooltip.add(LangHelpers.localize(Reference.TOOLTIP + "mob.gain", chicken.getGain()));
            tooltip.add(LangHelpers.localize(Reference.TOOLTIP + "mob.strength", chicken.getStrength()));
        }
        ...
        if (!chicken.isChild()) {
            ...
            if (layProgress > 0) {
                ...
                tooltip.add(LangHelpers.localize(Reference.TOOLTIP + "mob.layProgress", timeFormatted));
            }
        }
    }
