...
public class VoidResRecipeHandler extends RecipeHandlerBase {
    ...
    public String getRecipeID() {
        return ModObject.blockVoidResMiner.getRegistryName();
    }
    ...
    public void loadCraftingRecipes(ItemStack item) {
        ...
        IFocusableRegistry registry = VoidMinerRecipes.voidResMinerRegistry;
    ...
    public void loadUsageRecipes(ItemStack ingredient) {
        ...
        Item minerItem = ModBlocks.VOID_RES_MINER.getItem();
    ...
    public class CachedVoidResRecipe extends CachedBaseRecipe {
        ...
        public CachedVoidResRecipe(WeightedStackBase recipe, DyeColor color) {
            ...
            miners.add(ModBlocks.VOID_RES_MINER.newItemStack(1, 0));
            miners.add(ModBlocks.VOID_RES_MINER.newItemStack(1, 1));
            miners.add(ModBlocks.VOID_RES_MINER.newItemStack(1, 2));
            miners.add(ModBlocks.VOID_RES_MINER.newItemStack(1, 3));
