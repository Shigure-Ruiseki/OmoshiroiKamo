...
public class SolarArrayStructure {
    ...
    public static void registerStructureInfo() {
        ...
        IMultiblockInfoContainer.registerTileClass(TESolarArrayT5.class, new MultiblockInfoContainerT5(definition5));
        IMultiblockInfoContainer.registerTileClass(TESolarArrayT6.class, new MultiblockInfoContainerT6(definition6));
    ...
    private static class MultiblockInfoContainerT5 implements IMultiblockInfoContainer<TESolarArrayT5> {

        private final IStructureDefinition<TESolarArrayT5> structure;

        public MultiblockInfoContainerT5(IStructureDefinition<TESolarArrayT5> structure) {
            this.structure = structure;
        }

        @Override
        public void construct(ItemStack triggerStack, boolean hintsOnly, TESolarArrayT5 ctx, ExtendedFacing aSide) {
            int tier = ctx.getTier();
        ...
        @Override
        public int survivalConstruct(ItemStack triggerStack, int elementBudget, ISurvivalBuildEnvironment env,
            TESolarArrayT5 ctx, ExtendedFacing aSide) {
            int built = 0;
            int tier = ctx.getTier();
            built = this.structure.survivalBuild(
                ctx,
    ...
    private static class MultiblockInfoContainerT6 implements IMultiblockInfoContainer<TESolarArrayT6> {

        private final IStructureDefinition<TESolarArrayT6> structure;

        public MultiblockInfoContainerT6(IStructureDefinition<TESolarArrayT6> structure) {
            this.structure = structure;
        }

        @Override
        public void construct(ItemStack triggerStack, boolean hintsOnly, TESolarArrayT6 ctx, ExtendedFacing aSide) {
            int tier = ctx.getTier();
        ...
        @Override
        public int survivalConstruct(ItemStack triggerStack, int elementBudget, ISurvivalBuildEnvironment env,
            TESolarArrayT6 ctx, ExtendedFacing aSide) {
            int built = 0;
            int tier = ctx.getTier();
            built = this.structure.survivalBuild(
                ctx,
