...
public class BlockTrialKeystone extends AbstractBlock<TETrialKeystone> {

    protected BlockTrialKeystone() {
        super(ModObject.blockTrialKeystone.unlocalisedName, TETrialKeystone.class);
    }

    public static BlockTrialKeystone create() {
        return new BlockTrialKeystone();
    }
