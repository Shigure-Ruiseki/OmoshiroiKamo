...
public class QuantumExtractorRecipes {
    ...
    private static void loadOreTier(int tier) {
        ...
        if (file.exists()) {
            ...
            FocusableHandler.FocusableList defaults = getDefaultOreList();
    ...
    private static void loadResTier(int tier) {
        ...
        if (file.exists()) {
            ...
            FocusableHandler.FocusableList defaults = getDefaultResList();
            FocusableHandler.saveRegistryDefaultsToJson(file, defaults);
            FocusableHandler.loadIntoRegistry(defaults, reg);
        }
    }
    ...
    private static FocusableHandler.FocusableList getDefaultOreList() {
        ...
        defaults.addEntry(new FocusableHandler.FocusableBlock("rftools:dimensional_shard_ore", 0, EnumDye.WHITE, 4));
        defaults.addEntry(new FocusableHandler.FocusableBlock("mysticalagriculture:inferium_ore", 0, EnumDye.GREEN, 6));
        defaults
            .addEntry(new FocusableHandler.FocusableBlock("mysticalagriculture:prosperity_ore", 0, EnumDye.SILVER, 4));
        return defaults;
    }
    ...
    private static FocusableHandler.FocusableList getDefaultResList() {
        ...
        defaults.addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 0, EnumDye.WHITE, 1));
        defaults.addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 1, EnumDye.ORANGE, 1));
        defaults
            .addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 2, EnumDye.MAGENTA, 1));
        defaults
            .addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 3, EnumDye.LIGHT_BLUE, 1));
        defaults.addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 4, EnumDye.YELLOW, 1));
        defaults.addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 5, EnumDye.LIME, 1));
        defaults.addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 6, EnumDye.PINK, 1));
        defaults.addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 7, EnumDye.GRAY, 1));
        defaults.addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 8, EnumDye.SILVER, 1));
        defaults.addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 9, EnumDye.CYAN, 1));
        defaults
            .addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 10, EnumDye.PURPLE, 1));
        defaults.addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 11, EnumDye.BLUE, 1));
        defaults.addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 12, EnumDye.BROWN, 1));
        defaults.addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 13, EnumDye.GREEN, 1));
        defaults.addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 14, EnumDye.RED, 1));
        defaults.addEntry(new FocusableHandler.FocusableBlock("minecraft:stained_hardened_clay", 15, EnumDye.BLACK, 1));
        ...
        defaults.addEntry(new FocusableHandler.FocusableBlock(LibMisc.MOD_ID + ":hardened_stone", 0, EnumDye.GRAY, 10));
