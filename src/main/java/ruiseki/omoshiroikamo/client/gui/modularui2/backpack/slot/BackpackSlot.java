...
import static ruiseki.omoshiroikamo.common.block.backpack.BackpackItemStackHelper.getTooltipLower;
import static ruiseki.omoshiroikamo.common.block.backpack.BackpackItemStackHelper.matchesAllTerms;
...
public class BackpackSlot extends ItemSlot {
    ...
    private void drawLockedSlot(ModularGuiContext context, WidgetTheme widgetTheme) {
        MGuiTextures.NO_SORT_ICON.draw(context, 1, 1, 16, 16, widgetTheme);
        GlStateManager.disableDepth();
        GuiDraw.drawRect(1, 1, 17, 17, Color.argb(139, 139, 139, 128));
